        ...
        for (let i = this.bullets.length - 1; i >= 0; i--) {
            ...
            for (let j = this.tanks.length - 1; j >= 0; j--) {
                ...
                if (distance < tank.size / 2 + bullet.size / 2) {
                    ...
                    // Create explosion
                    this.explosions.push(new Explosion({ x: tank.position.x, y: tank.position.y }, result === 'destroyed' ? 30 : 15));
                    if (result === 'destroyed') {
            ...
            if (!bulletHit && this.player) {
                ...
                if (distance < this.player.size / 2 + bullet.size / 2) {
                    ...
                    this.explosions.push(new Explosion({ x: this.player.position.x, y: this.player.position.y }, 20));
                    this.screenShake = 8;
                    bulletHit = true;
...
//# sourceMappingURL=Game_refactored.js.map
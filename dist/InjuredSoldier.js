export class InjuredSoldier {
    ...
    getBleedOutPercentage() {
        return this.bleedOutTime / this.maxBleedOutTime;
    }
    render(ctx) {
        if (this.isRescued)
            return; // Don't render if already rescued
        ctx.save();
    ...
    renderBleedOutMeter(ctx, healthPercentage) {
        const meterWidth = 60;
        const meterHeight = 8;
...
//# sourceMappingURL=InjuredSoldier.js.map